...
function is_supported_git_function(text)
	return text:find("^git checkout ")
		or text:find("^git checkout %-%a ")
		or text:find("^git co ")
		or text:find("^git co %-%a ")
		or text:find("^git b ")
		or text:find("^git b %-%a ")
		or text:find("^git branch ")
		or text:find("^git branch %-%a ")
		or text:find("^git rebase ")
		or text:find("^git rebase %-%a ")
		or text:find("^git r ")
		or text:find("^git r %-%a ")
end
